...
using TodoAppRefreshToken.Models.DTO.Requests;
...
namespace TodoAppRefreshToken.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        private string RandomString(int length)
        {
            ...
            return new string(
                Enumerable.Repeat(chars, length).Select(x => x[rndm.Next(chars.Length)]).ToArray()
            );
        }
        ...
        [HttpPost]
        [Route("RefreshToken")]
        public async Task<IActionResult> RefressToken([FromBody] TokenRequest tokenRequest)
        {
            if (ModelState.IsValid)
            {
