...
namespace Bank_PaymentDetails.Models
{
    public class PaymentDetailsContext
    {
        ...
        public int AddPaymentDetails(PaymentDetailsItem details)
        {
            using (MySqlConnection conn = GetConnection())
            {
                conn.Open();
        ...
        public int UpdatePaymentDetails(int id, PaymentDetailsItem newDetails)
        {
            using (MySqlConnection conn = GetConnection())
            {
                conn.Open();
        ...
        public int DeletePaymentDetails(int id)
        {
            using (MySqlConnection conn = GetConnection())
            {
                conn.Open();
