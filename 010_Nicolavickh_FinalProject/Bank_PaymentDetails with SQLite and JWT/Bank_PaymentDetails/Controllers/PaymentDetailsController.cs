...
namespace Bank_PaymentDetails.Controllers 
{
    ...
    public class PaymentDetailsController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateItem(int id, ItemData item)
        {
            ...
            var existingItem = await _context.Items.FirstOrDefaultAsync(x => x.paymentDetailId == id);
            ...
            existingItem.cardOwnerName = item.cardOwnerName;
            existingItem.expirationDate = item.expirationDate;
            existingItem.securityCode = item.securityCode;
